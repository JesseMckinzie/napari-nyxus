...
.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/plugin_menu.png

A widget will appear in the Napari viewer to run Nyxus.

.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/nyxus_loaded.png
...
.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/open_image.png 
...
.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/convert_to_labels.png
...
.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/setup_calculation.png

After running Nyxus, the feature calculations will also appear in the Napari viewer.

.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/feature_results.png
...
.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/click_label.png
...
.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/double_click_label.png
...
.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/feature_colormap.png
...
.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/slider_feature.png
...
.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/run_on_colormap_labels.png
...
.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/heatmap_drop_down.png
...
.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/heatmap_toggle.png

After clicking the ``Generate Heatmap`` button, the feature calculation table will have the colormap applied.

.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/heatmap.png
...
.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/annotation_input.png

After clicking ``Extract annotation``, the annotation will appear as a new column in the feature calculation table.

.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/annotation_column.png
...
.. image:: https://github.com/JesseMckinzie/napari-nyxus/tree/add_read_the_docs/docs/source/img/sort_box.png
